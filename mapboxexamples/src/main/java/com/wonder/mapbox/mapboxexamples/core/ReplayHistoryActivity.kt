package com.wonder.mapbox.mapboxexamples.core
...
import com.mapbox.navigation.examples.core.R.drawable
import com.mapbox.navigation.examples.core.R.id
import com.mapbox.navigation.examples.core.R.string
import com.mapbox.navigation.examples.core.databinding.ActivityReplayHistoryLayoutBinding
import com.wonder.mapbox.mapboxexamples.core.replay.HistoryFileLoader
import com.wonder.mapbox.mapboxexamples.core.replay.HistoryFilesActivity
import com.wonder.mapbox.mapboxexamples.util.Utils
...
class ReplayHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(id.selectHistoryButton).setOnClickListener {
    ...
    override fun onDestroy() {
        super.onDestroy()
        findViewById<MapView>(id.mapView).onDestroy()
                ...
                locationComponent = binding.mapView.location.apply {
                    this.locationPuck = LocationPuck2D(
                        bearingImage = ContextCompat.getDrawable(
                            ...
                            drawable.mapbox_navigation_puck_icon
                        )
                    )
    ...
    private fun setupReplayControls() {
        ...
        binding.seekBarText.text = getString(
            string.replay_playback_speed_seekbar,
